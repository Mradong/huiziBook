<template>
	<view class="">
			...
			<view class="form">
				...
				<view class="form-one">
					<view class="form-row fixation">
						...
						<view class="warn" @click="openHint('subitems_fixation')"><image src="../../../static/images/warn.svg" mode=""></image></view>
					</view>
				...
				<view class="form-one">
					<view class="form-row">
						...
						<view class="warn" @click="openHint('selectTimemodel')"><image src="../../../static/images/warn.svg" mode=""></image></view>
					...
					<view class="form-row" v-if="subitems_timemodel == '新历'">
						...
						<view class="warn" @click="openHint('selectOnetime')"><image src="../../../static/images/warn.svg" mode=""></image></view>
				...
				<view class="form-one">
					<view class="form-row">
						...
						<view class="warn" @click="openHint('start_time')"><image src="../../../static/images/warn.svg" mode=""></image></view>
					</view>
					<view class="form-row">
						...
						<view class="warn" @click="openHint('end_time')"><image src="../../../static/images/warn.svg" mode=""></image></view>
					</view>
				</view>
			</view>
		</view>
		...
		<uni-popup ref="hint_popup" type="center">
			<uni-card :title="hint_title" thumbnail="../../../static/images/shuoming.svg"><view class="" v-html="hint_content"></view></uni-card>
		</uni-popup>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		getEndtime(date) {
			...
			//对时间做限制，明天完成
			let to_day = this.formatDate(new Date() ).replace(/(.+?)\-(.+?)\-(.+)/,"$1/$2/$3");
			let new_start_time =  date.replace(/(.+?)\-(.+?)\-(.+)/,"$1/$2/$3")
			console.log(to_day )
