<template>
	<view class="">
			...
			<view class="form">
				...
				<view class="form-one">
					<view class="form-row fixation">
						...
						<view class="warn" @click="openHint('subitems_fixation')">
				...
				<view class="form-one">
					<view class="form-row">
						...
						<view class="warn" @click="openHint('selectTimemodel')">
							<image src="../../../static/images/warn.svg" mode=""></image>
						</view>
					...
					<view class="form-row" v-if="subitems_timemodel == '新历'">
						...
						<view class="warn"  @click="openHint('selectOnetime')">
							<image src="../../../static/images/warn.svg" mode=""></image>
						</view>
		...
		<uni-popup ref="popup" type="dialog">
			<uni-popup-dialog type="error" title="错误" mode="base" content="请完善资料" :duration="2000" :before-close="true" @close="close"
			 @confirm="confirm"> </uni-popup-dialog>
		</uni-popup>
		<uni-popup ref="hint_popup" type="center" >
			<uni-card :title="hint_title" thumbnail="../../../static/images/shuoming.svg" >
				<view class="" v-html="hint_content">
			...
			createHuizi() {
				if (this.subitems_name && this.subitems_description && this.subitems_periods && this.subitems_profit) {
					...
					let payment_num_m = date.getDate() >= endTimeArr[2] ? date.getMonth() + 1 - endTimeArr[1] : date.getMonth() -
						endTimeArr[1];
					let payment_num = payment_num_y * 12 + payment_num_m > this.subitems_periods ? this.subitems_periods :
