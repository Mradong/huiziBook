...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; /**用法
...
var Lunar = {
  ...
  //@param year 阳历-年
  //@param month 阳历-月
  solarMonthDays: function solarMonthDays(year, month) {
    var FebDays = this.isLeapYear(year) ? 29 : 28;
    var monthHash = ['', 31, FebDays, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    return monthHash[month];
  },
  //农历月份天数
  lunarMonthDays: function lunarMonthDays(year, month) {
  ...
  //计算农历日期与正月初一相隔的天数
  betweenLunarDays: function betweenLunarDays(year, month, day) {
  ...
  //@param date 阴历-日
  toSolar: function toSolar(year, month, day) {
    var yearData = this.lunarInfo[year - this.MIN_YEAR];
...
{
  Lunar: Lunar };exports.default = _default;
